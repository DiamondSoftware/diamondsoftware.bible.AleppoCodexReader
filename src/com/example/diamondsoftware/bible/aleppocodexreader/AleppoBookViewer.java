...
import com.example.diamondsoftware.bible.aleppocodexreader.R;
...
public class AleppoBookViewer extends ImageView {
	...
	private void findCoordinatesVerse(int x, int y) {
		...
		GridLayout grid = (GridLayout) inflater.inflate(
				R.layout.activity_aleppo_book_viewer, null);
		final ListView verseList = (ListView) grid
